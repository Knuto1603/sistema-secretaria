...
readonly class SolicitudResponseDTO
{
    public function __construct(
        ...
        public ?string $archivo_sustento_url,
        public ?string $archivo_sustento_nombre,
        public ?string $constancia_pdf_url,
        public ?string $asignado_a,
        public ?string $observaciones_admin,
        public bool $fuera_de_plan,
        public ?string $respuesta_alumno,
        public ?string $fecha_respuesta,
        public ?string $respuesta_admin,
    ...
    public function toArray(): array
    {
        return [
            ...
            'archivo_sustento_url' => $this->archivo_sustento_url,
            'archivo_sustento_nombre' => $this->archivo_sustento_nombre,
            'constancia_pdf_url' => $this->constancia_pdf_url,
            'asignado_a' => $this->asignado_a,
            'observaciones_admin' => $this->observaciones_admin,
            'fuera_de_plan' => $this->fuera_de_plan,
            'respuesta_alumno' => $this->respuesta_alumno,
