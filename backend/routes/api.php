...
Route::middleware(['auth:sanctum', 'user.active'])->group(function () {
    ...
    Route::prefix('programacion-interactiva')
        ...
        ->group(function () {
            ...
            Route::post('/{id}/revertir', [\App\Http\Controllers\Api\V1\BorradorProgramacionController::class, 'revertir']);
    ...
    Route::prefix('usuarios/estudiantes')
        ...
        ->group(function () {
            ...
            Route::post('/import-reporte-matricula', [EstudianteController::class, 'importReporteMatricula']);
